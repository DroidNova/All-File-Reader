...
enum class PptxPhase { Resolving,Validating,Preparing,Rendering,Ready,Missing,PermissionDenied,LegacyUnsupported,MacroUnsupported,Encrypted,Corrupt,SafetyLimit,RenderTimeout,RendererCrash,Failure }
data class PptxReady(val file:File,val token:String)
data class PptxState(val fileName:String?=null,val phase:PptxPhase=PptxPhase.Resolving,val ready:PptxReady?=null)
