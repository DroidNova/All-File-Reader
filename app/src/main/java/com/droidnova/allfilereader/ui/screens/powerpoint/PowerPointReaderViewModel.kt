...
enum class PptxPhase { Resolving,Validating,Preparing,Rendering,Ready,Missing,PermissionDenied,LegacyValid,LegacyInvalid,LegacyAccessDenied,LegacyNoCompatibleApp,MacroUnsupported,Encrypted,Corrupt,SafetyLimit,RenderTimeout,RendererCrash,Failure }
data class PptxReady(val file:File,val token:String)
data class PptxState(val fileName:String?=null,val phase:PptxPhase=PptxPhase.Resolving,val ready:PptxReady?=null,val legacyUri:Uri?=null)
