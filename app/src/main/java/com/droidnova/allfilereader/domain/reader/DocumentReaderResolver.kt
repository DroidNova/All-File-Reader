...
enum class DocumentReaderDestination { Pdf, PlainText, Docx, LegacyWord, FutureOffice, Unsupported }
...
object DocumentReaderResolver {
    fun resolve(document: DocumentFile): DocumentReaderDestination = when (document.category) {
        ...
        DocumentCategory.Excel, DocumentCategory.PowerPoint -> DocumentReaderDestination.FutureOffice
