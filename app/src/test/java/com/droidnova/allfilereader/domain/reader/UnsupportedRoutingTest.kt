...
class UnsupportedRoutingTest {
 private fun file(ext:String,category:DocumentCategory=DocumentClassifier.classify(null,ext))=DocumentFile(ext,"file.$ext","file:///file.$ext",null,ext,1,1,category,false)
