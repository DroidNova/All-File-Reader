...
class DocumentClassifierPowerPointTest {
 @Test fun classifiesPptxCaseAndMime(){assertEquals(DocumentCategory.PowerPoint,DocumentClassifier.classifyMetadata("application/octet-stream","PPTX").category);assertEquals(DocumentCategory.PowerPoint,DocumentClassifier.classifyMetadata("application/vnd.openxmlformats-officedocument.presentationml.presentation",null).category)}
 @Test fun classifiesUnsupportedPowerPointFormats(){listOf("ppt","PPT","PPTM","pps","ppsx").forEach{assertEquals(DocumentCategory.PowerPoint,DocumentClassifier.classifyMetadata(null,it).category)}}
